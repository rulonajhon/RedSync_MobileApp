...
void main() {
  group('Session-Only Conversation Tests', () {
    ...
    setUp(() {
      ...
      testMessages = [
        ChatMessage(
          text: "Hello, I'm HemoAssist! I'm here to help you with hemophilia-related questions.",
          isUser: false,
        ),
        ChatMessage(
          text: "What are the symptoms of hemophilia?",
          isUser: true,
        ),
        ChatMessage(
          text: "Hemophilia symptoms include excessive bleeding, easy bruising, and prolonged bleeding after injuries or surgery...",
          isUser: false,
        ),
      ];
    });
    ...
    test('should clear messages when session ends (app restart simulation)', () {
    ...
    test('should preserve message timestamps during session', () {
      ...
      expect(sessionMessages[0].timestamp.millisecondsSinceEpoch, 
